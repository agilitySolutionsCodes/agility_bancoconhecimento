...
{
    public delegate void SelecionarContexto(string IdNo);

    public partial class ControleArvore : System.Web.UI.UserControl
    {
        public event SelecionarContexto OnSelecionarContexto;
        ...
        public int IdSelecionado
        {
            get
            {
                if (ArvoreBiblioteca.SelectedValue.Trim() != "")
                    return Convert.ToInt32(ArvoreBiblioteca.SelectedValue);
                else
                    return -1;
            }
        }
        ...
        protected void ArvoreBiblioteca_SelectedNodeChanged(object sender, EventArgs e)
        {
            ...
            {
                if (OnSelecionarContexto != null)
                {
                    OnSelecionarContexto(ArvoreBiblioteca.SelectedNode.Value);
                }
            }
        }
    }
